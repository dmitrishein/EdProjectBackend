...
namespace EdProject.BLL.Services
{
    ...
    //            throw new CustomException("Cannot create item, because it already exist", System.Net.HttpStatusCode.OK);
    ...
    //        if (!queryList.Any())
    //                throw new CustomException("No orders found", System.Net.HttpStatusCode.OK);
    ...
    //        if (!query.Any())
    //            throw new CustomException("No orders found :(", System.Net.HttpStatusCode.BadRequest);
